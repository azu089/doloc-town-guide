 ...
 "how-to-play": {
  ...
  "sections":[
   ...
   {"heading":"垂直农场：实际运作方式","body":"横版视角不是噱头——它就是整个农场系统。",
    "items":["平台可自由堆叠；每爬上一层都增加可建造表面。","跳跃与攀爬穿梭各层——平台跳跃是每日循环的一部分。","花盆放在平台上；按季节分组种植，便于一次换季补种。","用遮盖或「雨露均沾」基因保护露天作物，降低风暴与酸雨造成的侵蚀风险。","为无人机飞行留出垂直空隙——1.0 自动化需要清晰航线。"]},
   {"heading":"天气影响与应对方法","body":"极端天气是游戏的招牌。先识别风险，再准备对应的防护、浇水与响应。",
    "columns":["天气","影响","应对方法"],
    "rows":[["酸雨","侵蚀无遮盖的作物","建造遮盖；收集酸液作为制作资源"],["酷热","烤干土壤、拖慢生长","按时浇水；种植耐热基因品种"],["雷暴","破坏露天农田","用闪电给农场充电（1.0 自动化关键）"],["暴雨","淹没低处地块","让雨水免费灌溉；省下浇水体力"],["旱季（4月）","作物枯萎、作物压力增加","4 月前准备作物防护，按预报调整种植"]]},
   ...
   {"heading":"1.0 给新玩家带来的变化","body":"2026 年 8 月 6 日的 1.0 重构了前期体验。",
    "items":[["2026-08-06","1.0 上线：完整故事结局、旧城废墟、农业自动化、蘑菇节、37 个新成就。"],["新玩家","你比 EA 玩家更早实现自动化——两阶段自动化→无人机站代劳杂务。"],["旧城废墟","新区域：凶悍新敌人、新 NPC、支线与资源；许多道路通向那里。"],["⚠️ 验证中","精确解锁顺序与建造费用仍在 1.0 实测；标注 ⚠️ 的为社区来源。"]]},
   {"heading":"新手常见问题速答",
...
"automation": {
  ...
  "metaDescription":"多洛可小镇 1.0 农业自动化详解：建造两阶段自动化、部署农场无人机站，让无人机自动播种、培育与收割。",
  "intro":"1.0 把你从农民变成农场经理。这里是发电、部署无人机站、实现整条作物流水线自动化的方法。",
  "sections":[
   {"heading":"农业自动化如何运作","body":"自动化有三层：能源、站点与无人机。",
    "items":[["利用两阶段自动化","建造太阳能板与自动化设备，为农场生成清洁能源。"],["建造农场无人机站","站点是让无人机执行农场作业的控制点。"],["指派自动化任务","无人机端到端处理播种、培育与收获。"],["解放你的时间","无人机工作时，去探索、聊天或推进剧情。"]]},
   ...
   {"heading":"自动化路线图（草稿）",
    "columns":["阶段","获得内容","时机"],
    "rows":[["两阶段自动化","站点能源","前期-中期 ⚠️"],["第一座无人机站","自动播种","中期 ⚠️"],["完整作物循环","播种→培育→收割","后期 ⚠️"],["工业线","传送带+新区域","1.0 终局"]]},
...
ZH.update({
 ...
 "weather": {
  ...
  "sections":[
   {"heading":"天气威胁与应对",
    "columns":["天气","风险","应对"],
    "rows":[["酸雨","侵蚀作物","遮盖；收集酸液"],["酷热","烤干土壤","按时浇水；耐热基因"],["雷暴","农田受损","用闪电给农场蓄电"],["暴雨","淹没低地","免费灌溉"],["旱季（4月）","枯萎+作物压力增加","准备作物防护，规划浇水"]]},
...
JA = {
 "how-to-play": {
  ...
  "sections":[
   ...
   {"heading":"天候の影響まとめ","body":"異常気象には、予報確認・作物保護・水やりで対応する。",
    ...
    "rows":[["酸性雨","無防備な作物を侵食","カバーを建てる。酸を資源として回収"],["猛暑","地面を焼き、土を乾かす","水やりのタイミング調整。耐熱遺伝子品種"],["雷雨","露地を荒らす","落雷を農場の電力に変換"],["豪雨","低い区画を水没","雨に灌漑を任せる"],["乾季（4月）","Harsh Dry Season で作物保護と水やりが必要","作物を保護し、水やりを計画する"]]},
   ...
   {"heading":"1.0 で新規プレイヤーに変わること","body":"1.0 アップデート（2026年8月6日）で完全なストーリー結末、旧市街遺跡、農業オートメーション（二段階自動化→ドローン基地）、キノコ祭り、新実績37個が追加。今始めるなら、EA よりはるかに早く自動化に到達できます。⚠️ 正確な解放順は 1.0 で検証中。"},
   {"heading":"よくある質問",
 ...
 "automation": {
  ...
  "metaTitle":"ドロックタウン農業オートメーション：二段階自動化・ドローン基地（1.0）",
  "metaDescription":"ドロックタウン 1.0 の農業オートメーション：二段階自動化発電の建設、農場ドローン基地の展開、播種から収穫までの自動化。",
  ...
  "sections":[
   ...
   {"heading":"自動化ロードマップ（草案）",
    ...
    "rows":[["二段階自動化","基地のエネルギー","序盤～中盤 ⚠️"],["最初のドローン基地","自動播種","中盤 ⚠️"],["完全な作物サイクル","播種→育成→収穫","終盤 ⚠️"],["工業ライン","コンベア+新領域","1.0 エンドゲーム"]]},
...
JA.update({
 ...
 "weather": {
  ...
  "sections":[
   {"heading":"天候の脅威と対策",
    "columns":["天候","リスク","対策"],
     "rows":[["酸性雨","作物を侵食","カバー。酸の回収"],["猛暑","土を乾かす","タイミング水やり。耐熱遺伝子"],["雷雨","農地のダメージ","落雷を農場の電力に"],["豪雨","低地の水没","無料の灌漑"],["乾季（4月）","枯れ+作物への負担","作物を保護し、水やりを計画"]]},
 ...
 "update-log": {
  ...
  "sections":[
   ...
   {"heading":"1.0正式版ハイライト","body":"公式発表に基づく1.0 公式要点。",
    "items":["新地域：旧市街遺跡（3つ目の大型マップ地域）。","完全なメインストーリー結末。","農業オートメーション（二段階自動化→ドローン基地）。","キノコ祭り。","追加のキャラクターストーリー。","新ツール・戦闘ドローン・魚・アクセサリー。","新実績37個（合計80個）。","季節の天候変化とローカライズ拡張。"]}
  ]
 },
 "faq": {
 ...
 "how-long-to-beat": {
  ...
  "sections":[
   ...
   {"heading":"長くなる理由","body":"時間を最も消費するシステム。","items":[
    ...
    "農業オートメーション（二段階自動化→ドローン基地）は一つのツリー",
...
KO = {
 "how-to-play": {
  ...
  "sections":[
   ...
   {"heading":"날씨 영향 한눈에 보기","body":"극한 날씨에는 예보 확인, 작물 보호, 물주기로 대응합니다.",
    ...
    "rows":[["산성비","보호되지 않은 작물 침식","덮개 설치; 산을 자원으로 수집"],["폭염","땅을 태우고 흙을 말림","물주기 타이밍; 내열 유전자 품종"],["뇌우","노지 작물 피해","번개로 농장 전력 충전"],["폭우","낮은 구획 침수","빗물로 무료 관개"],["가뭄(4월)","작물 시들고 작물 부담 증가","작물을 보호하고 물주기를 계획"]]},
   ...
   {"heading":"1.0이 새 플레이어에게 주는 변화","body":"1.0 업데이트(2026년 8월 6일)로 완전한 스토리 결말, 구시가지 유적, 농업 자동화(2단계 자동화→드론 기지), 버섯 축제, 신규 업적 37개가 추가됐습니다. 지금 시작하면 EA보다 훨씬 일찍 자동화에 도달할 수 있습니다. ⚠️ 정확한 해금 순서는 1.0에서 검증 중입니다."},
   {"heading":"빠른 답변",
 ...
 "automation": {
  ...
  "metaTitle":"돌록 타운 농업 자동화: 2단계 자동화·드론 기지 (1.0)",
  "metaDescription":"돌록 타운 1.0 농업 자동화: 2단계 자동화 발전소 건설, 농장 드론 기지 배치, 드론이 파종부터 수확까지 자동 처리하는 방법.",
  "intro":"공식 1.0 공지는 2단계 농업 자동화와 작물 작업용 드론 스테이션을 설명합니다. 이 가이드는 공식 메커니즘과 플레이어 제보를 구분합니다.",
  "sections":[
   {"heading":"농업 자동화의 작동 방식","body":"자동화는 에너지·기지·드론 세 층으로 이루어집니다.",
    "items":[["2단계 자동화 활용","해금 조건과 필요한 재료를 확인한 뒤 자동화 장비를 배치합니다."],["농장 드론 기지 건설","기지는 드론이 농장 작업을 수행하게 하는 제어 지점입니다."],["자동 작업 지정","드론이 파종·육성·수확을 처음부터 끝까지 처리합니다."],["시간 확보","드론이 일하는 동안 탐험·대화·스토리 진행을 하세요."]]},
   ...
   {"heading":"자동화 로드맵 (초안)",
    "columns":["단계","얻는 것","시기"],
    "rows":[["2단계 자동화","기지 에너지","초~중반 ⚠️"],["첫 드론 기지","자동 파종","중반 ⚠️"],["전체 작물 주기","파종→육성→수확","후반 ⚠️"],["산업 라인","컨베이어+새 지역","1.0 엔드게임"]]},
...
KO.update({
 ...
 "weather": {
  ...
  "sections":[
   {"heading":"날씨 위협과 대응",
    "columns":["날씨","위험","대응"],
    "rows":[["산성비","작물 침식","덮개; 산 수집"],["폭염","흙을 말림","타이밍 물주기; 내열 유전자"],["뇌우","농장 피해","번개를 전력으로"],["폭우","저지대 침수","무료 관개"],["가뭄(4월)","시듦+작물 부담 증가","작물 보호 준비, 물주기 계획"]]},
 ...
 "update-log": {
  ...
  "sections":[
   ...
   {"heading":"1.0 정식 출시 하이라이트","body":"공식 발표 기준 1.0 공식 주요 내용.",
    "items":["새 지역: 구시가지 유적 (세 번째 대형 맵 지역).","완전한 메인 스토리 결말.","농업 자동화 시스템 (2단계 자동화→드론 기지).","버섯 축제.","추가 캐릭터 스토리.","새 도구·전투 드론·물고기·액세서리.","신규 업적 37개 (총 80개).","계절 날씨 변화와 현지화 확장."]}
  ]
 },
 "faq": {
 ...
 "how-long-to-beat": {
  ...
  "sections":[
   ...
   {"heading":"길어지는 이유","body":"가장 시간이 걸리는 시스템.","items":[
    ...
    "농업 자동화(2단계 자동화→드론 기지)는 하나의 테크 트리",
...
ES = {
 "how-to-play": {
  ...
  "sections":[
   ...
   {"heading":"Efectos del clima de un vistazo","body":"El clima extremo exige previsión, protección de cultivos y riego planificado.",
    ...
    "rows":[["Lluvia ácida","Erosiona cultivos sin proteger","Construye cubiertas; recoge el ácido"],["Calor abrasador","Quema la tierra","Riega con timing; usa cepas resistentes"],["Tormenta","Daña campos abiertos","Aprovecha los rayos para dar energía"],["Lluvia torrencial","Inunda parcelas bajas","Deja que riegue gratis"],["Sequía (mes 4)","Harsh Dry Season exige protección de cultivos y riego planificado","Protege los cultivos y planifica el riego"]]},
   ...
   {"heading":"Qué cambia el lanzamiento 1.0 para los nuevos jugadores","body":"La actualización 1.0 (6 de agosto de 2026) añade el final completo de la historia, las Ruinas de la Ciudad Vieja, la automatización agrícola (automatización en dos etapas → estaciones de drones), el Festival de las Setas y 37 logros nuevos. Si empiezas ahora, podrás automatizar mucho antes que en Early Access. ⚠️ El orden exacto de desbloqueo aún se está verificando en 1.0."},
 ...
 "automation": {
  ...
  "intro":"Los avisos oficiales de 1.0 describen automatización agrícola en dos etapas y estaciones de drones para tareas de cultivo. Esta guía separa esas mecánicas de los reportes de jugadores.",
  "sections":[
   ...
   {"heading":"¿Solar o automatización? Qué construir primero","body":"Empieza por comprobar las dos etapas oficiales de automatizaciÃ³n y las tareas de las estaciones de drones.",
 ...
 "sections": [
  ...
  },
  {
   ...
   "items": [
    ...
    [
     "1.0 能完全自动种田吗？",
     "能——两阶段自动化 + 无人机站负责播种、培育与收割，让你腾出手去探索、钓鱼和做任务。"
    ]
   ]
  }
 ]
...
KO["farming"] = {
 ...
 "sections": [
  ...
  },
  {
   ...
   "body": "가뭄 달(4월)에는 작물이 시들고 작물 부담이 커집습니다. 가뭄 전에 작물 보호 준비하고 그동안 물주기를 계획하세요. 흔한 실수: 노출된 작물을 보호하지 않기(극한 날씨에 취약), 과일나무를 미루기(나중에 공짜 돈), 낫 업그레이드 안 하기(집단 수확이 큰 시간 절약), '고루 내리는 비' 유전자가 있는데 전부 손으로 물주기, Bellad 퀘스트 건너뛰기(기술 포인트가 유일한 안정적인 초반 수입)."
  },
  {
   "type": "faq",
   "heading": "빠른 답변",
   "items": [
    ...
    [
     "1.0에서 농사가 완전 자동화되나요?",
     "네——2단계 자동화 + 드론 스테이션이 파종·육성·수확을 처리해 탐험·낚시·퀘스트에 시간을 쓸 수 있습니다."
    ]
   ]
  }
 ]
...
_EXTRA = {
 "zh-CN": {
  ...
  "make-money": {
   ...
   "metaDescription": "多洛可小镇怎么赚钱快？加工增值 10-20%、钓鱼烘干、4 月旱季的作物防护与浇水规划，以及第一天就该做对的开局动作。",
   "intro": "本指南区分官方机制与玩家报告的加工、钓鱼和前期升级技巧；具体数值请在自己的存档中确认。",
   "sections": [
    ...
    {"en": "Common Money Mistakes", "heading": "常见的赚钱错误", "body": "社区报告指出这些是玩家漏钱的方式：全卖原料（跳过 10-20% 的加工利润）、4 月前不准备作物防护与浇水、跳过任务（错过技术点这个收入放大器）、把鱼全卖光（失去 13 种鱼缸专属鱼的繁殖对）、迟迟不升背包（浪费几小时跑回家）。"},
    ...
    {"en": "Quick Answers", "heading": "常见问题速答",
     "items": [["多洛可小镇赚钱最快的方法是什么？", "社区共识是 鱼→烘干→卖：无种子成本、第一天就能做，烘干机增值 10-20% [L2]。"], ["加工能增值多少？", "腌菜、烘干、织布各约增值 10-20%，据社区报告 [L2]。"], ["4 月旱季怎么准备？", "提前保护作物，并按预报规划浇水。"], ["背包升级值得吗？", "值得——第一层大约翻倍槽位，是社区最推荐的第一笔购买 [L2]。"], ["自动化需要钱吗？", "后期需要：两阶段自动化与无人机站要材料和技术点，早期收入为 1.0 终局供血。"]]}
   ]
  }
 },
 "ja": {
  ...
  "make-money": {
   ...
   "metaDescription": "ドロックタウンでどうやって早く稼ぐ？加工で+10-20%、釣りと乾燥、4月の干ばつ前の作物保護と水やり、初日からやるべきことを解説。",
   "intro": "本ガイドは、公式の仕組みと、加工・釣り・序盤強化に関するプレイヤー報告を区別します。正確な数値は自分のセーブで確認してください。",
   "sections": [
    ...
    {"en": "Common Money Mistakes", "heading": "よくある金策ミス", "body": "コミュニティ報告が指摘するお金を逃すパターン：素材を全部生売り（10-20%の加工マージンを捨てる）、4月前に作物保護と水やりを準備しない、クエストをスキップ（収入の増幅器・テックポイントを逃す）、魚を全部売る（水槽限定13種の繁殖ペアを失う）、バックパック強化を後回し（往復で何時間も無駄にする）。"},
 ...
 "ko": {
  ...
  "make-money": {
   ...
   "metaDescription": "돌록 타운에서 돈을 빨리 버는 법: 가공 +10-20%, 낚시·건조, 4월 Harsh Dry Season 전 작물 보호와 물주기 계획, 첫날부터 해야 할 일까지.",
   "intro": "이 가이드는 공식 메커니즘과 플레이어가 제보한 가공·낚시·초반 업그레이드 팁을 구분합니다. 정확한 수치는 자신의 세이브에서 확인하세요.",
   "sections": [
    {"en": "The Money Loop, From Zero", "heading": "제로부터 시작하는 돈 루프", "body": "돌록 타운의 수입은 복리입니다 — 각 단계가 이전 단계의 수입을 증폭합니다. 이 순서로 쌓아 올리세요.",
    ...
    {"en": "Common Money Mistakes", "heading": "흔한 돈 버는 실수", "body": "커뮤니티가 지적하는 돈을 놓치는 패턴: 원자재를 전부 그대로 판매(10-20% 가공 마진 포기), 4월 전 작물 보호와 물주기를 준비하지 않아 작물이 시드는 것, 퀘스트 건너뛰기(수입 증폭기인 기술 포인트를 놓침), 물고기를 전부 판매(수조 전용 13종의 번식 쌍 상실), 가방 업그레이드 미루기(왕복에 몇 시간 낭비)."},
    ...
    {"en": "Quick Answers", "heading": "자주 묻는 질문",
     "items": [["돌록 타운에서 돈을 가장 빨리 버는 방법은?", "커뮤니티 합의는 물고기→건조→판매: 씨앗 비용 없음, 첫날부터 가능, 건조기 +10-20% [L2]."], ["가공은 얼마나 붙나요?", "절임·건조·직조 각각 품목당 약 10-20%, 커뮤니티 보고 기준 [L2]."], ["4월에는 어떻게 대비하나요?", "4월 Harsh Dry Season 전에 작물을 보호하고 물주기를 계획하세요. 공식 공지는 가격 변동이나 판매 시점을 뒷받침하지 않습니다."], ["가방 업그레이드는 가치 있나요?", "네 — 첫 단계가 슬롯을 약 2배로 늘리며 커뮤니티가 가장 추천하는 첫 구매입니다 [L2]."], ["자동화에 돈이 필요한가요?", "후반에는 필요: 2단계 자동화과 드론 기지에 재료와 기술 포인트가 듭니다. 초반 수입이 1.0 엔드게임을 뒷받침합니다."]]}
   ]
  }
 },
 "es": {
  ...
  "make-money": {
   ...
   "intro": "Esta guía distingue las mecánicas oficiales de los consejos de jugadores sobre procesado, pesca y mejoras tempranas; confirma los valores exactos en tu partida.",
   "sections": [
    ...
    {"en": "Common Money Mistakes", "heading": "Errores de dinero comunes", "body": "La comunidad señala estas formas de dejar dinero sobre la mesa: vender todo crudo (te saltas el 10-20% del procesado), no proteger los cultivos ni planificar el riego antes del mes 4, saltarte misiones (pierdes Puntos de Tecnología, el multiplicador de ingresos), vender todos los peces (pierdes las parejas de 13 especies de tanque) y retrasar la mochila (horas yendo a casa)."},
...
PATCH_COPY = {
 "en": {
  "patch_h":"Official patch 1.00.03 — August 10, 2026", "patch_b":"Official patch highlights; this is not a selected highlights.",
...
_seo = {
 "en": {"weather":"Extreme weather in Doloc Town: protect crops from acid rain and heat, understand Harsh Dry Season, and prepare for storms.","make-money":"Doloc Town money guide using clearly labelled community tips for processing, fishing and early priorities, without unsupported price-arbitrage claims."},
 "zh-CN": {"weather":"多洛可小镇天气攻略：应对酸雨、酷热、雷暴与第 4 月 Harsh Dry Season，保护作物并安排浇水。","make-money":"多洛可小镇赚钱攻略：区分社区技巧与官方事实，介绍加工、钓鱼和前期优先级，不采用未经证实的涨价倒卖说法。"},
 ...
 "ja": {"weather":"ドロックタウンの酸性雨・猛暑・雷雨・第4月 Harsh Dry Season に備え、作物保護と水やりを計画する天候ガイド。","make-money":"公式情報とコミュニティ報告を区別し、加工・釣り・序盤の優先事項をまとめた金策ガイド。未確認の価格攻略は掲載しません。"},
 "ko": {"weather":"돌록 타운의 산성비·폭염·뇌우·4번째 달 Harsh Dry Season에 대비해 작물 보호와 물주기를 계획하는 날씨 가이드.","make-money":"공식 사실과 커뮤니티 팁을 구분해 가공·낚시·초반 우선순위를 다루는 돈 가이드. 확인되지 않은 가격 거래 주장은 제외합니다."},
 "es": {"weather":"Guía del clima de Doloc Town: protege cultivos de lluvia ácida y calor y prepárate para tormentas y Harsh Dry Season.","make-money":"Guía de dinero de Doloc Town con consejos comunitarios señalados sobre procesado, pesca y prioridades, sin arbitraje de precios sin verificar."},
}
